    ...
    <div class="card mb-4 shadow">
        ...
        <div class="card-header py-3  bg-techbot-dark ">
            <nav class="navbar navbar-dark">
                <a class="navbar-brand text-light"> Add Student </a>
            </nav>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('admin.group-students-store',$group->id) }}">
                @csrf
                <div class="row">
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 bg-techbot-dark">
        <nav class="navbar  ">
            ...
            <div class="navbar-brand"><span id="componentDetailsTitle"> {{ $group->name }} (Students)</span> </div>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php $itr = 0; ?>
                    @foreach ($group->Students as $admin)
...
<script>
    $(document).ready(function () {
        ...
        var admins = @json($group->students);
        ...
        $('#data-edit-modal').on('show.bs.modal', function () {
            ...
            var link = "{{route('admin.group-students',$group->id)}}";
