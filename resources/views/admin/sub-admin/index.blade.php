    ...
    <div class="card mb-4 shadow">
        ...
        <div class="card-header py-3  bg-techbot-dark ">
            <nav class="navbar navbar-dark">
                <a class="navbar-brand text-light"> Add Sub Admin </a>
            </nav>
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.group-sub-admins-store',$group->id) }}">
                @csrf
                <div class="row">
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 bg-techbot-dark">
        <nav class="navbar  ">
            ...
            <div class="navbar-brand"><span id="componentDetailsTitle"> {{ $group->name }} (Sub Admins)</span> </div>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php $itr = 0; ?>
                    @foreach ($group->sub_admins as $admin)
                    ...
                    <tr class="data-row">
                        ...
                        <td class="align-middle">
                            ...
                            <form method="POST" action="{{ route('admin.group-sub-admins-delete',[$group->id,$admin->id]) }}" id="delete-form-{{ $admin->id }}" style="display:none; ">
                                {{csrf_field() }}
                                {{ method_field("delete") }}
                            </form>
...
<script>
    $(document).ready(function () {
        ...
        var admins = @json($group->sub_admins);
        ...
        $('#data-edit-modal').on('show.bs.modal', function () {
            ...
            var link = "{{route('admin.group-sub-admins',$group->id)}}";
