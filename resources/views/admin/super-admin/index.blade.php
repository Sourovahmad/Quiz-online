    ...
    <div class="card mb-4 shadow">
        ...
        <div class="card-header py-3  bg-techbot-dark ">
            <nav class="navbar navbar-dark">
                <a class="navbar-brand text-light"> Add Super Admin </a>
            </nav>
        </div>
        <div class="card-body">
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 bg-techbot-dark">
        <nav class="navbar  ">
            ...
            <div class="navbar-brand"><span id="componentDetailsTitle">Super Admins</span> </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#data-edit-modal').on('show.bs.modal', function () {
            ...
            var link = "{{route('admin.super-admins')}}";
